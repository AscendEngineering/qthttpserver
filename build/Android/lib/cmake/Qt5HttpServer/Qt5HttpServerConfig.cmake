...
macro(_populate_HttpServer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5HttpServer_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::HttpServer PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5HttpServer_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::HttpServer)
    ...
    set(_Qt5HttpServer_MODULE_DEPENDENCIES "SslServer;WebSockets;Network;Core")
    ...
    set(_Qt5HttpServer_LIB_DEPENDENCIES "Qt5::SslServer;Qt5::WebSockets;Qt5::Network;Qt5::Core")
    ...
    set_property(TARGET Qt5::HttpServer
    ...
    if (_Qt5HttpServer_PRIVATE_DIRS_EXIST)
        ...
        if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::HttpServerPrivate)
            add_library(Qt::HttpServerPrivate INTERFACE IMPORTED)
            set_target_properties(Qt::HttpServerPrivate PROPERTIES
                INTERFACE_LINK_LIBRARIES "Qt5::HttpServerPrivate"
            )
        endif()
    endif()


    _populate_HttpServer_target_properties(DEBUG "libQt5HttpServer_${ANDROID_ABI}.so" "" FALSE)



    # In Qt 5.15 the glob pattern was relaxed to also catch plugins not literally named Plugin.
    # Define QT5_STRICT_PLUGIN_GLOB or ModuleName_STRICT_PLUGIN_GLOB to revert to old behavior.
    if (QT5_STRICT_PLUGIN_GLOB OR Qt5HttpServer_STRICT_PLUGIN_GLOB)
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5HttpServer_*Plugin.cmake")
    else()
        file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5HttpServer_*.cmake")
    endif()
...
# Add a versionless target, for compatibility with Qt6.
if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND TARGET Qt5::HttpServer AND NOT TARGET Qt::HttpServer)
    add_library(Qt::HttpServer INTERFACE IMPORTED)
    set_target_properties(Qt::HttpServer PROPERTIES
        INTERFACE_LINK_LIBRARIES "Qt5::HttpServer"
    )
endif()
