...
macro(_populate_SslServer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5SslServer_install_prefix}/lib/${LIB_LOCATION}")
    ...
    set_target_properties(Qt5::SslServer PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5SslServer_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::SslServer)
    ...
    _populate_SslServer_target_properties(DEBUG "libQt5SslServer_${ANDROID_ABI}.so" "" FALSE)
